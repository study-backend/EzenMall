...
<script>
	document.addEventListener("DOMContentLoaded", function() {
		...
		btn_chk_id.addEventListener("click", function() {
			if(form.id.value.length < 4) { // 아이디를 4글자 미만을 입력했을 때
			...
			<tr>	
	 		...
	 		<tr class="addr_row">	
				...
				<td>
					...
					<input type="text" name="address" size="51"><br>	
					<input type="text" name="address2" size="51">				
				</td> 	
	 		</tr>
	 	</table>
	 	<div class="btns">
	 		<input type="button" value="회원가입" id="btn_insert">&ensp;&ensp;
