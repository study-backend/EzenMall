...
$(document).ready(function(){
  ...
  $('.slider').bxSlider({
        ...
        slideMargin: 20,
        touchEnabled: false,  //웹화면의 touch이벤트 제거 -> 이미지를 클릭했을 떄 해당 페이지로 이동 가능
  });
});
</script>
</head>
...
//메인2: 베스트셀러(모든 상품에서 최신상품1개씩을 리스트에 담아서 리턴)
String[] nProducts2 = {"110", "120", "220", "230", "240", "250", "310", "320", "410", "420", "510", "610", "620",
...
<div id="container">
	...
	<div><%-- 메인(본문) --%>
		...
		<%--
			...
			<%-- 메인2: 베스트셀러(모든 신상품을 가져와서 slick으로 노출)  --%>
			...
			<article class="best_items"> <%--메인3: 베스트셀러(주문수량이 가장 많은 상품 20개를 가져와서 노출시킴 --%>
			</article>
			
			<article class="kind_items"> <%-- 메인4: 상품 종류별로 나열되도록 설정한 영역 --%>
