...
@import url('https://fonts.googleapis.com/css2?family=Do+Hyeon&family=Paytone+One&display=swap');
...
/*중단 - 상품 등록 테이블*/
table { width:100%; border: 1px solid #2f9e77; border-collapse: collapse; border-top: 2px solid #2f9e77; 
border-bottom: 2px solid #2f9e77; border-left: hidden; border-right:hidden;}
tr { height: 35px;}
...
/*하단- 버튼*/
select {height: 24px;}
input::file-selector-button { width: 80px; height:28px; background: #2f9e77; color: #fff; border: none;
...
<div id="container">
	...
	<%--encytype으로는 정보를 못 받음 그래서 멀티 --%>
		<table>
			...
			<tr>
				<th>상품 내용</th>
				<td><textarea  name="product_content" rows="15" cols="58"></textarea></td>		
			</tr>
			<tr>
				<th>할인율</th>
