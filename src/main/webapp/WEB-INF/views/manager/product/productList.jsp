...
.f_row {text-align: center; color: red;}
/*하단: 페이징 영역*/
...
<body>
<%
//검색 처리- 검색일때는 search가 1이고 검색이 아닐때는 serach가 0
...
//매 페이지마다 전체 상품수에 대한 역순번호 
int number = cnt - ((currentPage-1) * pageSize); 
%>
<div id="container">
    <%-- 상단: 타이틀 --%>
	<div class="m_title"><a href="productList.jsp">EZEN MALL</a></div>
	<div class="s_title"><a href="productList.jsp">상품 목록</a></div>
	<%-- 상단: 상품수, 아이디, 로그아웃, 상품등록 --%>
	<div class="top_info">
